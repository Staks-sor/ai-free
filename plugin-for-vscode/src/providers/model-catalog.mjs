...
export const PROVIDER_CATALOG = {
  ...
  chatgpt: {
    ...
    models: [
      { id: "gpt-5.5-instant", label: "GPT-5.5 Instant", apiModel: "gpt-5.5-instant", webLabels: ["Instant", "Мгновенный"] },
      { id: "gpt-5.6-sol-medium", label: "GPT-5.6 Sol · Medium", apiModel: "gpt-5.6-sol-medium", webLabels: ["Medium", "Средний"], reasoning: true },
      ...
      { id: "gpt-5.5", label: "GPT-5.5", apiModel: "gpt-5.5-instant", legacy: true },
      { id: "gpt-4o", label: "GPT-4o", apiModel: "gpt-4o", legacy: true },
      { id: "gpt-4o-mini", label: "GPT-4o mini", apiModel: "gpt-4o-mini", legacy: true },
      { id: "o1-mini", label: "o1 mini", apiModel: "o1-mini", reasoning: true, legacy: true },
      { id: "o3-mini", label: "o3 mini", apiModel: "o3-mini", reasoning: true, legacy: true },
    ],
  },
  economyos: {
    id: "economyos",
