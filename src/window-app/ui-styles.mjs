...
export const STYLES = `
    :root {
      ...
      --orange-text: #fbbf24;
      --pink-text: #f9a8d4;
      --giveaway-accent: #67e8f9;
      --giveaway-step: #22d3ee;
    }
    body[data-theme="light"] {
      ...
      --orange-text: #92400e;
      --pink-text: #be185d;
      --giveaway-accent: #087c94;
      --giveaway-step: #087c94;
      --code-bg: #f3f5f9;
    }
    body[data-theme="contrast"] {
      ...
      --giveaway-accent: #005e73;
      --giveaway-step: #005e73;
      --blue-text: #003db8;
      --purple-text: #5b21b6;
      --teal-text: #00695c;
      --green-text: #006b2d;
    ...
    * { box-sizing: border-box; }
    ...
    .sidebarPromoVibe {
      --promo-a: rgba(6, 182, 212, 0.22);
      --promo-b: rgba(244, 63, 94, 0.16);
      --promo-border: rgba(250, 204, 21, 0.56);
      animation-delay: -3s;
    }
    .sidebarGiveaway {
      min-height: 96px;
    ...
    .sidebarGiveaway > strong {
      grid-area: title;
      font-size: 13px;
      line-height: 1.15;
    }
    .sidebarGiveawayPrize {
      grid-area: prize;
    ...
    .vibePromoPanel { width: min(680px, 94vw); max-width: 680px; }
    .vibePromoBody { display: grid; gap: 20px; padding: 24px 26px 26px; }
    .vibePromoBody p { margin: 0; line-height: 1.5; }
    .giveawayPrizeCard {
      display: grid;
      grid-template-columns: minmax(0, 1fr) auto;
      align-items: end;
      ...
      border-radius: 7px;
      background: linear-gradient(120deg, rgba(6, 182, 212, 0.22), rgba(244, 63, 94, 0.17));
      box-shadow: inset 0 0 28px rgba(103, 232, 249, 0.05), 0 10px 28px rgba(0, 0, 0, 0.14);
    }
    .giveawayEyebrow {
      grid-column: 1 / -1;
      color: #facc15;
    ...
    .giveawayPrizeCard strong { color: var(--giveaway-accent); font-size: 30px; line-height: 1.1; }
    .giveawayPrizeCard > span:last-child { color: var(--text); font-size: 14px; font-weight: 800; }
    .giveawayDeadline {
      display: grid;
      gap: 5px;
      padding: 11px 14px;
    ...
    .giveawayDeadline strong { font-weight: 900; }
    .giveawayDeadline span { color: var(--giveaway-accent); font-size: 13px; font-weight: 800; }
    .giveawayModels {
      color: var(--muted);
      font-size: 14px;
      text-align: center;
    ...
    .giveawaySteps li { display: grid; grid-template-columns: 32px minmax(0, 1fr); gap: 12px; align-items: start; }
    .giveawaySteps li > span {
      width: 32px;
      height: 32px;
      display: grid;
      place-items: center;
      ...
      color: var(--giveaway-step);
      font-weight: 900;
    }
    .giveawaySteps p { color: var(--muted); font-size: 14px; }
    .giveawaySteps strong { color: var(--text); }
    .vibePromoActions { display: grid; grid-template-columns: 1fr 1fr; width: 100%; margin-top: 3px; }
    .vibePromoActions a { min-height: 42px; display: inline-flex; align-items: center; justify-content: center; text-decoration: none; padding: 0 14px; }
    .giveawayPending {
      min-height: 34px;
      display: grid;
      place-items: center;
    ...
    @media (max-width: 560px) {
      .vibePromoBody { gap: 14px; padding: 18px 16px 20px; }
      .giveawayPrizeCard { grid-template-columns: 1fr; }
      .vibePromoActions { grid-template-columns: 1fr; }
    }
    .sidebarPromoMark {
      width: 24px;
      height: 24px;
