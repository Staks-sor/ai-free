...
<p align="center"><strong>AI Free 0.4.5</strong></p>
...
Текущий релиз — **AI Free 0.4.5**. Desktop/CLI/API и расширение VS Code выпускаются под единым номером версии. Он синхронно хранится в корневом `package.json` и `plugin-for-vscode/package.json`; общий релизный тег имеет формат `vX.Y.Z`.

Что вошло в `0.4.5`: [release notes](docs/RELEASE_NOTES_0.4.5.md).
